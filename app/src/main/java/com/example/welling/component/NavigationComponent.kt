...
fun NavigationComponent() {
    ...
    NavHost(navController = navController, startDestination = "start_setting_screen") {
        composable("start_setting_screen") { StartSettingScreen(navController, mainViewModel = MainViewModel()) }
